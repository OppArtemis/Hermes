...
public class MyServlet extends HttpServlet {
    ...
    static String targetEmail = "oppartemis@gmail.com";
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        FirebaseOptions options = new FirebaseOptions.Builder()
                .setServiceAccount(getServletContext().getResourceAsStream("/WEB-INF/ToDoFirebaseProject-f2d807490498.json"))
                .setDatabaseUrl("https://todofirebaseproject-f7eee.firebaseio.com/")
                .build();
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                // loading http://todofirebaseproject-f7eee.appspot.com/send-email in your browser.
                ...
                try {
                    ...
                    msg.setFrom(new InternetAddress("reminder@todofirebaseproject-f7eee.appspotmail.com",
                            "Todo Reminder"));
                    msg.addRecipient(Message.RecipientType.TO,
                            new InternetAddress(targetEmail, "Recipient"));
